...
asdf<-fread("EXOMES_1.0_comas.txt",sep="\t",header=T,data.table = F)
...
exac_split_filt_1<-grep("TRUE",sapply(lapply(exac_split,as.numeric),"<",0.05))
...
#gnomAD
gnomad_split<-strsplit(asdf[,filt_cols[2]],",")
gnomad_split_filt_1<-grep("TRUE",sapply(lapply(gnomad_split,as.numeric),"<",0.05))
gnomad_split_filt_2<-grep("TRUE",sapply(lapply(gnomad_split,as.numeric),is.na))
gnomad_split_filt_3<-grep("0",sapply(lapply(gnomad_split,as.numeric),length))
gnomad_split_filt<-sort(c(gnomad_split_filt_1,gnomad_split_filt_2,gnomad_split_filt_3))
gnomad_split_filt<-gnomad_split_filt[which(duplicated(gnomad_split_filt)==FALSE)]

asdf<-asdf[gnomad_split_filt,]
...
##phyloP
phylop_split<-strsplit(asdf[,filt_cols[3]],",")
phylop_split_na<-grep("0",sapply(sapply(lapply(phylop_split,as.numeric),">",1.6),length))
phylop_split_filt<-grep("TRUE",sapply(lapply(phylop_split,as.numeric),">",1.6))
...
#SIFT
sift_split<-strsplit(asdf[,filt_cols[4]],",")
...
#Polyphen2_HVAR
pp2_split<-strsplit(asdf[,filt_cols[5]],",")
...
#CADD
cadd_split<-strsplit(asdf[,filt_cols[6]],",")
#cadd_split_na<-grep("0",sapply(sapply(lapply(cadd_split,as.numeric),">",15.0),length))
cadd_split_filt<-grep("TRUE",sapply(lapply(cadd_split,as.numeric),">",15.0))
d<-rep(0,length(cadd_split))
#a[cadd_split_na]<-0.25
d[cadd_split_filt]<-1


#LRT
lrt_split<-strsplit(asdf[,filt_cols[7]],",")
...
#MutationTaster
mutationtaster_split<-strsplit(asdf[,filt_cols[8]],",")
...
NAME2 <- paste(dir_output, NAME, "__WES_3.0_commas_by_family.xls", sep="") 
...
#gnomAD
gnomad_split<-strsplit(asdf[,filt_cols[2]],",")
gnomad_split_filt_1<-grep("TRUE",sapply(lapply(gnomad_split,as.numeric),"<",0.01))
gnomad_split_filt_2<-grep("TRUE",sapply(lapply(gnomad_split,as.numeric),is.na))
gnomad_split_filt_3<-grep("0",sapply(lapply(gnomad_split,as.numeric),length))
gnomad_split_filt<-sort(c(gnomad_split_filt_1,gnomad_split_filt_2,gnomad_split_filt_3))
gnomad_split_filt<-gnomad_split_filt[which(duplicated(gnomad_split_filt)==FALSE)]
...
NAME2 <- paste(dir_output, NAME, "__WES_6.0_commas_by_family.xls", sep="") 
WriteXLS("all_fams", NAME2)
...
NAME2 <- paste(dir_output, NAME, "__","WES_3.0_commas",".Homoz_by_family.xls", sep="") 
WriteXLS(all_fams_2_homo, NAME2)


NAME2 <- paste(dir_output, NAME, "__","WES_3.0_commas",".Comp-Het_by_family.xls", sep="") 
...
NAME2 <- paste(dir_output, NAME, "__","WES_6.0_commas",".Homoz_by_family.xls", sep="") 
WriteXLS(all_fams_2_homo, NAME2)


NAME2 <- paste(dir_output, NAME, "__","WES_6.0_commas",".Comp-Het_by_family.xls", sep="") 
WriteXLS(all_fams_2_chet, NAME2)
