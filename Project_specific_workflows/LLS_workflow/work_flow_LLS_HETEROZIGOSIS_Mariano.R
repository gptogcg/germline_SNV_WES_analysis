...
fq_filters <- which((EXOMES_1.0$dbNSFP_1000Gp1_AF <= 0.01 | is.na(EXOMES_1.0$dbNSFP_1000Gp1_AF)) 
                    & (EXOMES_1.0$dbNSFP_ESP6500_AA_AF <= 0.01 | is.na(EXOMES_1.0$dbNSFP_ESP6500_AA_AF)) 
                    & (EXOMES_1.0$dbNSFP_ESP6500_EA_AF <= 0.01 | is.na(EXOMES_1.0$dbNSFP_ESP6500_EA_AF))
                    & (EXOMES_1.0$dbNSFP_ExAC_Adj_AF <= 0.01 | is.na(EXOMES_1.0$dbNSFP_ExAC_Adj_AF))
...
inner_frequency_filter <- which(EXOMES_1.0.2$inner_frequency <= 1.0) ## no filtra sino que agarra todas ##
...
df_CLL_2.0 <- read.table("./RESULTS_1eraSalida/ANTELO_01__df_CLL_2.0.txt", header = T, sep = "\t")
...
fq_filters <- which( (EXOMES_5.0$dbNSFP_1000Gp1_AF <= 0.001 | is.na(EXOMES_5.0$dbNSFP_1000Gp1_AF)) 
                     & (EXOMES_5.0$dbNSFP_ESP6500_AA_AF <= 0.001 | is.na(EXOMES_5.0$dbNSFP_ESP6500_AA_AF)) 
                     & (EXOMES_5.0$dbNSFP_ESP6500_EA_AF <= 0.001 | is.na(EXOMES_5.0$dbNSFP_ESP6500_EA_AF))
                     & (EXOMES_5.0$dbNSFP_ExAC_Adj_AF <= 0.001 | is.na(EXOMES_5.0$dbNSFP_ExAC_Adj_AF))## agregado de dbNSFP_Adj_ExAC_AF ##
                     & (EXOMES_5.0$gnomAD_Ex_AF <= 0.001 | is.na(EXOMES_5.0$gnomAD_Ex_AF))## agregado de gnomAD_Ex_AF ##
                     & (EXOMES_5.0$ExAC_AF <= 0.001 | is.na(EXOMES_5.0$ExAC_AF)) & (EXOMES_5.0$inner_frequency <=1))
