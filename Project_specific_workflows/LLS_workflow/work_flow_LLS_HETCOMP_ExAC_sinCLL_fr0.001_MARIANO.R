...
dir_input <- ""
dir.create("RESULTS_homo_HetComp_ExAC_only_sinCLL_fr0.001")
dir_output <- "./RESULTS_homo_HetComp_ExAC_only_sinCLL_fr0.001/"
...
fq_filters <- which( (EXOMES_1.0$dbNSFP_ExAC_Adj_AF <= 0.001 | is.na(EXOMES_1.0$dbNSFP_ExAC_Adj_AF))
                    & (EXOMES_1.0$gnomAD_Ex_AF <= 0.001 | is.na(EXOMES_1.0$gnomAD_Ex_AF))
                    & (EXOMES_1.0$ExAC_AF <= 0.001 | is.na(EXOMES_1.0$ExAC_AF)))
